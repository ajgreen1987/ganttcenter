...
@implementation HBGCBeaconManager
...
- (void)beaconManager:(ESTBeaconManager *)manager didChangeAuthorizationStatus:(CLAuthorizationStatus)status
{
    ...
    if ([self.delegate respondsToSelector:@selector(beaconManager:didChangeAuthorizationStatus:)])
    {
        [self.delegate beaconManager:manager didChangeAuthorizationStatus:status];
    }
}
...
- (void)beaconManager:(ESTBeaconManager *)manager didRangeBeacons:(NSArray *)beacons inRegion:(ESTBeaconRegion *)region
{
    ...
    if ([self.delegate respondsToSelector:@selector(allBeaconsDiscovered)])
    {
        [self.delegate allBeaconsDiscovered];
    }
}
